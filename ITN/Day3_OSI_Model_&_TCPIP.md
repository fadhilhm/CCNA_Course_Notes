...
[Source: Day 3 | Interfaces and Cables](https://youtu.be/yM-XNq9ADlI?si=Ym9lkvzqzFtHJwEh)

> Quiz starts at 25:12

## What is a networking model?

Networking models categorize and provide a structure for networking protocols and standards.

Protocols are a set of logical rules defining how network devices and software should work alone and together.

Standards allow network communication between different devices.

## OSI MODEL

An attempt to standardizing network communications.
...
![image](assets/OSI_upper.png)

Mnemonic to help remember the Data Layer Names / Order

![image](assets/OSI_acronym.png)
...
- Is not the application itself but the protocols that interact with it.
...
- Establishes, manages, and terminates connections between local application (e.g. your web browser) and the remote application (e.g. YouTube).
...
- Breaks large pieces of data into smaller segments which can be more easily sent over the network and are less likely to cause transmission problems if errors occur. <br> (e.g. sending videos by segment of data, so even when an error occurs you could still watch some of the video)
...
- Provides the way/means to select the shortest path to destination.
- **ROUTERS** operate at Layer 3.

When Data and the Layer 4 Header arrive in the Network Layer, it receives a Layer 3 Header. <br>
Layer 3 Header contains source and destination IP Address.
...
![image](assets/layer_interactions.png)
