...
A computer network is a digital telecommunications network which allow NODES to share RESOURCES. <br>
...
2. can be placed 'inside' or 'outside' the network <br> (after passing router vs before reaching router).
