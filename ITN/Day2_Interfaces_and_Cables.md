...
[Source: Day 2 | Interfaces and Cables](https://youtu.be/ieTH5lVhNaY?si=n7HQP15sgbfl4Zho)

> Quiz starts at 28:26
...
UTP Cable are used to connect to the RJ-45 ports.

!![Example](assets/RJ-45.png)
...
![image](assets/pc-switch_UTP.png)
...
![image](assets/router-switch_UTP.png)
...
Each wire pair is **bidirectional**, so there's no dedicated pair for transmit/receive data. This causes it to be much faster than 10/100BASE-T.

![image](assets/1000BASE-T.png)
...
- It needs both on each end so they can transmit/receive.


4 parts to a fiber-optic cable.

![image](assets/fiberoptic.png)


There are TWO types of fiberoptic cable.

In the example:
- The center is the fiberglass core itself.
- The blue part is the cladding that reflects light.

1. Single-Mode:

![image](assets/fiber_single.png)
